  ...
  return (
    <div className="pt-16">
      <div className="relative z-10 min-h-[calc(100vh-4rem)] flex flex-col md:flex-row gap-8 p-8">
        ...
        <div className="w-full md:w-[60%] bg-slate-900/50 backdrop-blur-lg border border-slate-700 rounded-3xl shadow-lg p-8 flex items-center justify-center">
          <AnimatePresence mode="wait">
            {selectedEvent ? (
              ...
              <motion.div
                ...
                className="text-center glass-card text-white/70"
              >
        ...
        <div className="w-full md:w-[40%] bg-slate-900/50 backdrop-blur-lg border border-slate-700 rounded-3xl shadow-lg p-8 flex flex-col">
          <div className="flex-shrink-0 mb-6">
            <h2 className="text-3xl font-bold text-white mb-4">Events</h2>
            <div className="flex space-x-2 bg-slate-800/60 p-1 rounded-full">
            ...
            <div className="space-y-4">
              {filteredEvents.map(event => (
                <motion.div
                  ...
                  className={`p-4 rounded-xl cursor-pointer transition-all duration-300 border ${selectedEvent?.id === event.id ? 'bg-slate-700/80 border-neon-yellow' : 'bg-slate-800/60 border-transparent hover:bg-slate-700/80'}`}>
